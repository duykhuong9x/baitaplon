<?php
    return array(
    	...
    	'general_font' => "normal 12px/1.35 Arial,Helvetica,sans-serif",
    	...
    	'h3_font' => 'normal 18px/1.35 Open Sans,Arial,Helvetica,sans-serif',
    	'h4_font' => "normal 16px/1.35 Open Sans,Arial,Helvetica,sans-serif",
    	'h5_font' => "normal 14px/1.35 Arial,Helvetica,sans-serif",
        'h6_font' => "normal 12px/1.35 Open Sans,helvetica,arial,sans-serif",        
        ...
        'dropmenu_font' => "normal 13px/1.35 Arial,Helvetica,sans-serif",
