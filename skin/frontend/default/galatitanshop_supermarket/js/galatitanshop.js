...
(function($) {
	...
	function bootstrap_fluid() {
		$('div.container').each(function() {
			if ((!$(this).hasClass('area03_container')) && (!$(this).hasClass('footer_top_container')) && (!$(this).hasClass('footer_container'))) {
				$(this).removeClass('container').addClass('container-fluild');
			}
		});
	};
	/**
	...
	function persistentMenu() {
		if (FREEZED_TOP_MENU != 0 && !isMobile) {
...
function initIsotope(id) {
	if (!isPhone) {
		...
		jQuery(id + ' ul.products-grid').isotope({
			itemSelector: '.item',
			masonry: {},
			layoutMode: 'masonry',
		});
