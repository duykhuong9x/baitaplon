<?php
class Gala_Galatitanshopsettings_Adminhtml_Galatitanshopsettings_ThemeController extends Mage_Adminhtml_Controller_Action
{
	protected $_prefixBlock = 'galatitanshop_';
	protected $_prefixPage = 'galatitanshop_';
	protected $_packageTheme = 'default/galatitanshop';
	...
	public function exportAction(){
		...
		$this->exportThemeFrameworkArea($root,$doc);
		...
		//echo $docWidgetInstance->saveXml();
		echo $doc->saveXML();
	}
	...
	*/
	...
	public function exportThemeFrameworkArea($root,$doc){
		$r = $doc->createElement( 'themeframework' );
		$root->appendChild($r);
		$collection = Mage::getModel($this->_themeFrameworkAreaModel)->getCollection()
